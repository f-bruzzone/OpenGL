...
//
//
//void RenderMirror(const Shader& shader, unsigned int frameTexture, unsigned int vao, const glm::mat4& view, const glm::mat4& perspective, const glm::vec3& position)
//{
//    shader.Bind();
...
//        glm::mat4 projection;
//
//        glm::vec3 mirrorPosition{ 0.0f, 0.0f, -2.0f };
//        glm::vec3 mirrorNormal{ 0.0f, 0.0f, 1.0f };
//
...
//            auto camLookDir = glm::normalize(camera.GetPosition());
//
//            auto virtualCamPos = camera.GetPosition() - 2.0f * glm::dot(camera.GetPosition() - mirrorPosition, mirrorNormal) * mirrorNormal;
//
//            auto mirrorLookDir = glm::reflect(camLookDir, mirrorNormal);
//            auto reflectedUp = glm::reflect(glm::vec3(0, 1, 0), mirrorNormal);
//            view = glm::lookAt(virtualCamPos, virtualCamPos + mirrorLookDir, reflectedUp);
//
...
//
//            // make mirror
//            RenderMirror(shader, frameColorBufferTex, vao, view, projection, mirrorPosition);
//
//            RenderWindow(shader, windowTex, vao, view, projection, glm::vec3(1.0f, 0.0f, 1.0f));
//            RenderWindow(shader, windowTex, vao, view, projection, glm::vec3(1.0f, 0.0f, 0.0f));
//

...
//
//
//void RenderCube(const Shader& shader, unsigned int vao, const glm::mat4& view, const glm::mat4& perspective, const glm::vec3& position, bool scale)
//{
...
//        Shader shader2{ "res/shaders/Group2/BorderShader.shader" };
...
//            glStencilMask(0xFF);
//
//            RenderCube(shader, vao, view, projection, glm::vec3(-1.0f, 0.0f, 0.0f), false);
//            RenderCube(shader, vao, view, projection, glm::vec3(2.0f, 0.0f, -1.0f), false);
//
//
...
//            glStencilMask(0x00);
//            shader2.Bind();
//            RenderCube(shader, vao, view, projection, glm::vec3(-1.0f, 0.0f, 0.0f), true);
//            RenderCube(shader, vao, view, projection, glm::vec3(2.0f, 0.0f, -1.0f), true);
//
//            glEnable(GL_DEPTH_TEST);
//            glStencilFunc(GL_ALWAYS, 1, 0xFF);
//            glStencilMask(0xFF);

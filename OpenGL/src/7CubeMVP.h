...
//
//        ShaderProgram shader = ParseShader("res/shaders/MVPCubeShader.shader");
...
//
//
//        glm::mat4 projection = glm::perspective(glm::radians(30.0f), 640.0f / 480.0f, 0.01f, 100.0f);
//        glm::mat4 view = glm::lookAt(glm::vec3(10, 5, 4), glm::vec3(0), glm::vec3(0, 1, 0));
